window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/data/disk/dsh-workspaces/personal/repos/dsh-dock-host/src/client/features/dock-host/DockButtonsRow.module.css.mjs
		const css = "@media (prefers-reduced-motion:reduce){.Pt_LLq_menu{transition:none!important}}";
		...
		var DockButtonsRow_module_css_default = { "menu": "Pt_LLq_menu" };
		//#endregion
